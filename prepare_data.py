...
def create_sgm_samples(in_file,split="train"):  
...
create_sgm_samples("rcv1_train_all_generated_tl.json",split="train")
create_sgm_samples("rcv1_test_all_generated.json",split="test")
create_sgm_samples("rcv1_val_all_generated.json",split="valid")
